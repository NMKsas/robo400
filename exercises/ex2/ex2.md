...
## TASK 3: Modify `Dockerfile` to include ROS integration for Gazebo 

As the exercise 2.3 specifies, you need to install packages to run ROS integration for Gazebo.
Update the Dockerfile to include the specified [installations](https://github.com/gazebosim/ros_gz/tree/humble#install). 
...
- When building new containers, remember to remove unused images/containers, which tend to take a lot of space 