...
`volumes:` binds directories. In this case, docker will bind the directory which we earlier created, `./ros2env/src`, to container's directory `/up/ros2env/src`. In practice, whatever you add and modify within your **local** `./ros2env/src` directory, exists within the container.
...
Now you have a setup for docker launching terminals. 

## Exercises 

Extra instructions/tips are provided within the [exercises](exercises/) folder.
The exercise instructions have some additional tasks - these small exercises guide you with docker usage. For experienced users or people who know they will be working on Software Engineering side of robotics, I strongly recommend learning the extra parts for setting up your environment. 
